...
# Log 檔案路徑
LOG_FILE = "/tmp/esun_login_log_HY.txt"
...
try:
    ...
    # 填入身份證字號
    log("填入身份證字號...")
    driver.find_element(By.ID, "iInputCHID").send_keys("F226228024")
    time.sleep(0.5)
    
    # 填入出生年月日
    log("填入出生年月日...")
    driver.find_element(By.ID, "iInputDTBR").send_keys("0750506")
    time.sleep(0.5)
